...
%% [0] 形状関数の計算
[ p_vec_RI, w_vec_RI] = Gauss( N_gauss_RI);          %% Gauss-Legendre求積の分点と重みの算出
...
for ii = 1:N_element
    ...
    i_xi_a = 1;
    for xi_a = p_vec_RI                        %% Gauss-Legendre求積
        i_eta_a = 1;
        for eta_a = p_vec_RI

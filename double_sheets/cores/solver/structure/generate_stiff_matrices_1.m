...
if flag_output == 1     
    ...
    for ii = 1:N_element
        ...
        Qe_eps_vec_i_1(:,ii) = int_dq_e_Dp_e;                                 %% ii要素の外力行列
        ...
        dq_Qe_eps_mat_i_1(:,:,ii) = int_dqdq_e_Dp_e_P_dq_e_Dp_dq_e;       	%% ii要素の外力行列
        ...
        if theta_a ~= 0                                                     %% 構造減衰が存在する場合のみ計算 (計算コスト削減)
            ...
            Qd_eps_mat_i_1(:,:,ii) = int_dq_e_Dp_dq_e;                        %% ii要素の外力行列
        end    
...
for ii = 1:N_element
    ...
    Qe_k_vec_i_1(:,ii) = int_dq_k_Dp_k;                                       %% ii要素の外力行列

...
%%[1-0] Distance vector between the collocation points and the panel node points [m]
...
%%[1-1] Induced velocity evaluation


%%%[*] The vortex core size is set from the largest wake cell length
...
h1 = h1(:,1:3:end);                                             %% Faster than evaluating Kv for every component.
...
h2 = h2(:,1:3:end);                                             %% Faster than evaluating Kv for every component.
...
h3 = h3(:,1:3:end);                                             %% Faster than evaluating Kv for every component.
...
h4 = h4(:,1:3:end);                                             %% Faster than evaluating Kv for every component.
